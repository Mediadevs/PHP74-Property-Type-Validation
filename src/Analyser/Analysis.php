...
class Analysis
{
    ...
    private const ANALYSER_OPTIONS = array(
        ...
        'analyse-function-parameters-docblock'      => AnalyseFunction::class,
        'analyse-function-return-docblock'          => AnalyseFunction::class,
        'analyse-function-docblock'                 => AnalyseFunction::class,
        // Magic Method Analysers
        'analyse-magic-method'                      => AnalyseFunction::class,
        'analyse-magic-method-parameters'           => AnalyseFunction::class,
        'analyse-magic-method-return'               => AnalyseFunction::class,
        'analyse-magic-method-parameters-docblock'  => AnalyseFunction::class,
        'analyse-magic-method-return-docblock'      => AnalyseFunction::class,
        'analyse-magic-method-docblock'             => AnalyseFunction::class,
        // Method Analysers
        'analyse-method'                            => AnalyseFunction::class,
        'analyse-method-parameters'                 => AnalyseFunction::class,
        'analyse-method-return'                     => AnalyseFunction::class,
